            ...
            try
            {
                if (id>0)
                {
                    ...
                    if (currentAssignment!=null)
                    {
                        ...
                        throw new Exception("Görev bulundu ama beklenmedik bir hata nedeniyle güncelleştirme başarısız oldu!");
                    }
                    throw new Exception("Görev bulunamadı. Gönderdiğiniz id'yi kontrol ediniz!");
                }
